...
const TransactionPage = ({ params }: { params: { slug: string } }) => {
  ...
  const handleVoucherCheck = () => {
    ...
    axiosInstance
      ...
      .then((res) => {
        ...
        toast.success(
          `Voucher valid! Potongan Rp ${discount.toLocaleString()}`
        );
      })
      .catch(() => {
        setDiscountAmount(0);
        toast.error("Voucher tidak valid atau tidak berlaku untuk event ini.");
      });
  };
